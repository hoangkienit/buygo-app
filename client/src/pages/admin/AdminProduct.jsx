...
export const AdminProduct = () => {
  ...
  const filteredProducts = products.filter((product) => {
    const matchesSearch = product.productId
      .toLowerCase()
  ...
  return (
    <div className="admin-product-container">
      ...
      <div className="admin-product-header">
        ...
        <a
          href="/super-admin/products/add-product"
              ...
              currentProducts.map((tx, index) => (
                <tr key={tx.productId}>
                  ...
                  <td>
                    <a
                      onClick={() =>
                        navigate(`/super-admin/products/view/${tx.productId}`)
                      }
                  ...
                  <td className="action-cell">
                    <div className="action-buttons-container">
                      ...
                      <button
                        onClick={() =>
                          navigate(`/super-admin/products/edit/${tx.productId}`)
                        }
